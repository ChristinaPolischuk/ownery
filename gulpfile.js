...
let path = {
    ...
    src: {
        ...
        libsCss: [source_folder + '/js/libs/mCustomScrollbar/jquery.mCustomScrollbar.css', source_folder + '/js/libs/simplebar/simplebar.css', source_folder + '/js/libs/noUiSlider/nouislider.css', source_folder + '/js/libs/select2/select2.min.css'],
        js: [source_folder + '/js/scripts.js', source_folder + '/js/app.js'],
        libsJS: [source_folder + '/js/libs/jquery-3.7.0(lib).min.js', source_folder + '/js/libs/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js', source_folder + '/js/libs/simplebar/simplebar.min.js', source_folder + '/js/libs/noUiSlider/nouislider.js', source_folder + '/js/libs/select2/select2.min.js', source_folder + '/js/libs/mixitup.min.js'],
